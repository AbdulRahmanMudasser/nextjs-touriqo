  ...
  return (
    <div className="relative group">
      <button
        ...
        className="flex items-center gap-1 text-white hover:text-[#22c55e] transition-colors font-medium text-sm uppercase tracking-wide py-2 px-3 focus:outline-none"
